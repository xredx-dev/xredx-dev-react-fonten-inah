...
const Login = () => {
    ...
    <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
        ...
        <div class="form-control">
            ...
            <input type="text" placeholder="correo" class="input input-bordered" />
        </div>
        <div class="form-control">
            <label class="label">
            <span class="label-text">Contraseña</span>
            </label>
            <input type="text" placeholder="conraseña" class="input input-bordered" />
            <label class="label">
            <a href="Forgot.jsx" class="label-text-alt link link-hover">¿No recuendas tu contraseña?</a>
            </label>
        </div>
